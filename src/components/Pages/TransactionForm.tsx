          ...
          <Stack spacing={3} sx={{ mt: 1 }}>
            {showError && (
              <Alert severity="error">
                Transaction should not be added as Income is less than or Equal
                to Expense
              </Alert>
            )}
            {formError && (
              <Alert severity="error">
                Expiry Date should be Greater then or Equal Transaction Date
              </Alert>
            )}
            <Box component="form">
              <Stack spacing={2}>
                  ...
                  <>
                    <TextField
                      ...
                      onChange={(e) =>
                        setValues({
                          ...values,
                          interval: e.target.value as Type,
                        })
                      }
                      required
                    >
